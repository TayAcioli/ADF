 ...
 */
import { ContentService, LogService, NodePermissionSubject, TranslationService, UploadService, PermissionsEnum } from '@alfresco/adf-core';
import { EventEmitter, OnChanges, OnInit, SimpleChanges, NgZone } from '@angular/core';
...
export declare class UploadButtonComponent extends UploadBase implements OnInit, OnChanges, NodePermissionSubject {
    ...
    constructor(uploadService: UploadService, contentService: ContentService, translationService: TranslationService, logService: LogService, ngZone: NgZone);
    ngOnInit(): void;
