 ...
 */
import { DataRow, ThumbnailService } from '@alfresco/adf-core';
...
export declare class ShareDataRow implements DataRow {
    ...
    cssClass: string;
    readonly node: MinimalNodeEntity;
    constructor(obj: MinimalNodeEntity, documentListService: DocumentListService, permissionsStyle: PermissionStyleModel[], thumbnailService?: ThumbnailService);
