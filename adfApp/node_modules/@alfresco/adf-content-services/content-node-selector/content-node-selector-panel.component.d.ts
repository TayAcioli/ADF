...
import { AlfrescoApiService, HighlightDirective, UserPreferencesService, PaginatedComponent, PaginationModel } from '@alfresco/adf-core';
...
export declare type ValidationFunction = (entry: MinimalNodeEntryEntity) => boolean;
export declare class ContentNodeSelectorPanelComponent implements OnInit, PaginatedComponent {
    ...
    inDialog: boolean;
    _chosenNode: MinimalNodeEntryEntity;
    ...
    constructor(contentNodeSelectorService: ContentNodeSelectorService, apiService: AlfrescoApiService, customResourcesService: CustomResourcesService, preferences: UserPreferencesService);
     ...
     */
    showBreadcrumbs(): true | MinimalNodeEntryEntity;
    /**
     * Loads the next batch of search results
     *
     * @param event Pagination object
