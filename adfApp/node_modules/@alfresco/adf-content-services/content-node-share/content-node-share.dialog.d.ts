...
export declare class ShareDialogComponent implements OnInit, OnDestroy {
    ...
    constructor(sharedLinksApiService: SharedLinksApiService, dialogRef: MatDialogRef<ShareDialogComponent>, dialog: MatDialog, nodesApiService: NodesApiService, contentService: ContentService, data: any);
    ngOnInit(): void;
    ngOnDestroy(): void;
    removeShare(): void;
