...
export declare class LoginComponent implements OnInit {
     ...
     * @param translate
     */
    constructor(_fb: FormBuilder, authService: AuthenticationService, translateService: TranslationService, logService: LogService, elementRef: ElementRef, router: Router, appConfig: AppConfigService, userPreferences: UserPreferencesService, settingsService: SettingsService);
    ngOnInit(): void;
    submit(): void;
    /**
