...
.adf-breadcrumb {
  ...
  .adf-breadcrumb-dropdown-trigger {
    ...
    .adf-breadcrumb-dropdown-trigger-arrow {
      ...
      color: white;
      z-index: 2; }
    .adf-breadcrumb-dropdown-trigger-arrow.isRoot {
      visibility: hidden; }
    .adf-breadcrumb-dropdown-trigger-arrow.focus {
      border: none; }
  .adf-breadcrumb-dropdown-trigger.isRoot {
    cursor: not-allowed; }
  .adf-breadcrumb-item {
    padding-right: 2px;
    overflow: hidden;
...
.adf-dropdown-breadcrumb-trigger.isRoot {
  cursor: not-allowed; }
...
.adf-content-node-selector-content {
  ...
  .adf-content-node-selector-content-breadcrumb .adf-dropddown-breadcrumb-item-chevron {
    color: rgba(0, 0, 0, 0.45); }
  .adf-content-node-selector-content-list {
    ...
    .adf-content-node-selector-content-list .adf-highlight {
      color: #00bcd4; }
    .adf-content-node-selector-content-list .adf-data-table {
      border: none; }
      .adf-content-node-selector-content-list .adf-data-table .adf-datatable-selected > svg {
        fill: #00bcd4 !important; }
      .adf-content-node-selector-content-list .adf-data-table .adf-no-content-container {
        text-align: center;
        border: none !important; }
      .adf-content-node-selector-content-list .adf-data-table .adf-data-table-cell {
        padding-top: 8px;
        padding-bottom: 8px;
        height: 30px; }
        .adf-content-node-selector-content-list .adf-data-table .adf-data-table-cell .adf-name-location-cell-location {
          display: none; }
        .adf-content-node-selector-content-list .adf-data-table .adf-data-table-cell .adf-name-location-cell-name {
          padding: 0; }
        .adf-content-node-selector-content-list .adf-data-table .adf-data-table-cell--image {
          padding-left: 16px;
          padding-right: 8px; }
        .adf-content-node-selector-content-list .adf-data-table .adf-data-table-cell--text {
          padding-left: 8px; }
      .adf-content-node-selector-content-list .adf-data-table .adf-datatable-body .adf-datatable-row {
        height: auto !important; }
        .adf-content-node-selector-content-list .adf-data-table .adf-datatable-body .adf-datatable-row:first-child .adf-data-table-cell {
          border-top: none; }
        .adf-content-node-selector-content-list .adf-data-table .adf-datatable-body .adf-datatable-row:last-child .adf-data-table-cell {
          border-bottom: none; }
    .adf-content-node-selector-content-list-searchLayout .adf-data-table .adf-data-table-cell {
      height: 56px;
      padding-bottom: 24px; }
      .adf-content-node-selector-content-list-searchLayout .adf-data-table .adf-data-table-cell .adf-name-location-cell-location {
        display: block; }
      .adf-content-node-selector-content-list-searchLayout .adf-data-table .adf-data-table-cell .adf-name-location-cell-name {
        padding: 5px 0 2px 0; }
      .adf-content-node-selector-content-list-searchLayout .adf-data-table .adf-data-table-cell.adf-content-selector-modified-cell {
        display: none; }
      .adf-content-node-selector-content-list-searchLayout .adf-data-table .adf-data-table-cell.adf-content-selector-modifier-cell {
        display: none; }
      .adf-content-node-selector-content-list-searchLayout .adf-data-table .adf-data-table-cell--image {
        padding-left: 16px;
        padding-right: 8px;
        padding-bottom: 8px; }
...
.adf-datatable-gallery-thumbnails .adf-data-table-card .adf-datatable-row {
  height: 300px !important; }
  .adf-datatable-gallery-thumbnails .adf-data-table-card .adf-datatable-row img {
    height: 100px; }
  .adf-datatable-gallery-thumbnails .adf-data-table-card .adf-datatable-row :first-child .cell-container .cell-value {
    display: flex;
    width: 265px;
    flex: 0 0 auto;
    justify-content: center; }
  .adf-datatable-gallery-thumbnails .adf-data-table-card .adf-datatable-row .adf-data-table-cell.adf-datatable-table-cell.adf-data-table-cell--image {
    flex: 0 0 auto;
    display: flex;
...
.upload-dialog {
  ...
  .upload-dialog mat-icon {
    cursor: pointer; }

.adf-search-container {
  overflow: hidden !important; }
  .adf-search-container adf-search-bar {
    width: 200px; }
...
.adf-content-node-selector-dialog .mat-dialog-actions {
  ...
  .adf-content-node-selector-dialog .mat-dialog-actions button {
    text-transform: uppercase;
    font-weight: normal; }
  .adf-content-node-selector-dialog .mat-dialog-actions .choose-action[disabled] {
    opacity: 0.6; }
  .adf-content-node-selector-dialog .mat-dialog-actions .choose-action:enabled {
    color: #00bcd4; }
...
.adf-add-permission-dialog .mat-dialog-actions {
  ...
  .adf-add-permission-dialog .mat-dialog-actions button {
    text-transform: uppercase;
    font-weight: normal; }
  .adf-add-permission-dialog .mat-dialog-actions .choose-action[disabled] {
    opacity: 0.6; }
  .adf-add-permission-dialog .mat-dialog-actions .choose-action:enabled {
    color: #00bcd4; }
...
.adf-new-task-layout-card {
  width: 66%;
  margin: 10px auto; }
  .adf-new-task-layout-card-content {
    display: flex;
    flex-flow: row;
    flex-wrap: wrap;
    justify-content: space-between; }
    .adf-new-task-layout-card-content .adf-grid-row {
      display: flex;
      flex-flow: row;
      flex-wrap: wrap;
      justify-content: space-between;
      margin-bottom: 8px; }
    .adf-new-task-layout-card-content .adf-grid-column {
      display: flex;
      flex-flow: column; }
    .adf-new-task-layout-card-content .adf-grid-full-width {
      width: 100%; }
    .adf-new-task-layout-card-content .adf-grid-half-width {
      width: 49%; }
...
#people-widget-content .mat-form-field {
  width: 100%; }

#people-widget-content .adf-label {
  line-height: 0; }

#people-widget-content .adf-error-text-container {
  margin-top: -10px; }
...
.adf-people-search {
  width: 100%; }
  .adf-people-search .activiti-label {
    font-weight: bolder; }
  .adf-people-search .fix-element-user-list {
    padding-top: 0px;
    padding-right: 0px;
    padding-bottom: 0px;
    padding-left: 0px; }
  .adf-people-search .search-text-header {
    font-weight: bold;
    opacity: 0.54; }
  .adf-people-search .search-list-action-container {
    border-top: 1px solid #eee;
    text-align: right;
    padding: 5px 0px;
    margin-top: 5px; }
    .adf-people-search .search-list-action-container > button {
      opacity: 0.54;
      font-weight: bolder; }
      .adf-people-search .search-list-action-container > button:hover {
        color: #00bcd4; }

.adf-people-search-field {
  width: 100%; }
  .adf-people-search-field .search-text-container {
    width: 100%; }
    .adf-people-search-field .search-text-container input {
      line-height: normal; }
  .adf-people-search-field .search-list-container {
    max-height: 152px;
    width: 100%;
    overflow-y: auto; }
  .adf-people-search-field adf-people-list ::ng-deep adf-datatable ::ng-deep thead {
    display: none; }
  .adf-people-search-field .people-pic {
    background: #00bcd4;
    width: 30px;
    padding: 10px 5px;
    border-radius: 90%;
  ...
  .adf-people-search-field .people-img {
    border-radius: 90%;
    width: 40px;
    height: 40px;
...
adf-people-list adf-datatable .adf-data-table .adf-data-table-cell .cell-container {
  flex-direction: column;
  align-items: left; }
...
.adf-task-people-list .adf-data-table {
  width: 0; }
  ...
  .adf-app-listgrid-item {
    ...
    .adf-app-listgrid-item-card {
      ...
      .adf-app-listgrid-item-card-subtitle {
        ...
        z-index: 9999;
        padding: 16px; }
        .adf-app-listgrid-item-card-subtitle .line-clamp {
          position: relative;
          line-height: 1.25;
          padding: 0 !important;
          overflow: hidden;
...
.adf-attach-file-widget-dialog .mat-dialog-actions {
  ...
  .adf-attach-file-widget-dialog .mat-dialog-actions button {
    text-transform: uppercase;
    font-weight: normal; }
  .adf-attach-file-widget-dialog .mat-dialog-actions .choose-action[disabled] {
    opacity: 0.6; }
  .adf-attach-file-widget-dialog .mat-dialog-actions .choose-action:enabled {
    color: #00bcd4; }
...
.adf-textitem-editable-controls {
  display: flex; }
  .adf-textitem-editable-controls mat-icon:hover {
    opacity: 1;
    cursor: pointer; }
...
.adf-panel .mat-expansion-panel {
  transition: none !important;
  box-shadow: none !important;
  background: none !important; }

.adf-panel .mat-expansion-panel-body {
  padding: 1px !important; }

.adf-panel .mat-expansion-panel-header {
  padding: 0px !important; }

.adf-panel .mat-expansion-panel-header-title {
  margin-right: 0px !important; }

.adf-panel .mat-expansion-indicator {
  margin-right: 25px !important; }

.adf-data-table-card {
  border: 1px solid rgba(0, 0, 0, 0.12); }
  .adf-data-table-card .adf-datatable-body {
    flex-flow: row wrap;
    display: flex;
    width: 100%;
    ...
    .adf-data-table-card .adf-datatable-body .adf-datatable-row {
      ...
      .adf-data-table-card .adf-datatable-body .adf-datatable-row:not([class*='mat-elevation-z']) {
        box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12); }
    .adf-data-table-card .adf-datatable-body .adf-datatable-row-empty-card {
      height: 0 !important;
      padding-top: 0;
      padding-bottom: 0;
      margin-top: 0;
      margin-bottom: 0; }
    .adf-data-table-card .adf-datatable-body .is-selected {
      background: #b2ebf2;
      padding-bottom: 31px; }
    .adf-data-table-card .adf-datatable-body .adf-data-table-card-permission {
      width: 100%;
      min-height: 250px; }
      .adf-data-table-card .adf-datatable-body .adf-data-table-card-permission .adf-datatable-table-cell {
        height: 240px !important; }
    .adf-data-table-card .adf-datatable-body .adf-data-table-card-loading {
      width: 100%;
      min-height: 250px; }
      .adf-data-table-card .adf-datatable-body .adf-data-table-card-loading .adf-datatable-table-cell {
        height: 240px !important; }
    .adf-data-table-card .adf-datatable-body .adf-data-table-card-empty {
      width: 100%;
      min-height: 380px; }
      .adf-data-table-card .adf-datatable-body .adf-data-table-card-empty .adf-datatable-table-cell {
        height: 370px !important; }
    .adf-data-table-card .adf-datatable-body .adf-datatable-table-cell {
      text-align: left;
      flex: 0 1 24%;
      ...
      overflow: hidden;
      outline: none; }
      .adf-data-table-card .adf-datatable-body .adf-datatable-table-cell:before {
        margin-left: 10px;
        text-align: left;
        content: attr(title);
        color: rgba(0, 0, 0, 0.4);
        ...
        text-overflow: ellipsis;
        overflow: hidden; }
    .adf-data-table-card .adf-datatable-body .alfresco-datatable__actions-cell {
      position: absolute;
      height: 42px !important;
      width: 42px !important;
      right: 0px;
      text-align: right; }
    .adf-data-table-card .adf-datatable-body .image-table-cell {
      margin: 8px;
      padding: 4px;
      overflow: visible;
      border-bottom-color: rgba(0, 0, 0, 0.12);
      ...
      .adf-data-table-card .adf-datatable-body .image-table-cell .cell-container {
        float: left;
        width: 42px; }
      .adf-data-table-card .adf-datatable-body .image-table-cell:after {
        margin: 2px;
        ...
        text-overflow: ellipsis;
        overflow: hidden; }
    .adf-data-table-card .adf-datatable-body .adf-datatable-table-checkbox {
      margin: 8px; }
  .adf-data-table-card .adf-datatable-header {
    margin-right: 18px;
    float: right; }
...
.adf-data-table {
  ...
  /* Utils */
  /* mobile phone */ }
  .adf-data-table .adf-datatable-row {
    display: table-row;
    vertical-align: inherit;
    border-color: inherit; }
  .adf-data-table .adf-datatable-body {
    display: table-row-group;
    vertical-align: middle;
    border-color: inherit; }
  .adf-data-table .adf-datatable-table-cell {
    display: table-cell; }
  .adf-data-table .adf-datatable-table-cell-header {
    display: table-cell; }
  .adf-data-table .adf-datatable-header {
    padding-bottom: 3px;
    display: table-header-group;
    vertical-align: middle;
    border-color: inherit; }
  .adf-data-table .adf-datatable-body .adf-datatable-row {
    cursor: pointer;
    position: relative;
    height: 56px;
    ...
    .adf-data-table .adf-datatable-body .adf-datatable-row:hover {
      background-color: rgba(0, 0, 0, 0.04); }
    .adf-data-table .adf-datatable-body .adf-datatable-row.is-selected, .adf-data-table .adf-datatable-body .adf-datatable-row.is-selected:hover {
      background-color: #e0e0e0; }
    .adf-data-table .adf-datatable-body .adf-datatable-row:focus {
      outline-offset: -1px;
      outline-width: 1px;
      outline-color: #448aff;
      outline-style: solid; }
    .adf-data-table .adf-datatable-body .adf-datatable-row:last-child > td {
      border-bottom: 1px solid rgba(0, 0, 0, 0.07); }
  .adf-data-table .adf-datatable-table-cell, .adf-data-table .adf-datatable-table-cell-header {
    padding: 0 18px 12px 18px;
    text-align: left; }
    .adf-data-table .adf-datatable-table-cell:first-of-type, .adf-data-table .adf-datatable-table-cell-header:first-of-type {
      padding-left: 24px; }
    .adf-data-table .adf-datatable-table-cell:last-of-type, .adf-data-table .adf-datatable-table-cell-header:last-of-type {
      padding-right: 24px; }
    .adf-data-table .adf-datatable-table-cell:focus, .adf-data-table .adf-datatable-table-cell-header:focus {
      outline-offset: -1px;
      outline-width: 1px;
      outline-color: #448aff;
      outline-style: solid; }
  ...
  .adf-data-table .adf-datatable-table-cell-header {
    ...
    box-sizing: border-box;
    white-space: nowrap; }
    .adf-data-table .adf-datatable-table-cell-header.sortable {
      -webkit-touch-callout: none;
      -webkit-user-select: none;
      -khtml-user-select: none;
      -moz-user-select: none;
      -ms-user-select: none;
      user-select: none; }
      .adf-data-table .adf-datatable-table-cell-header.sortable:hover {
        cursor: pointer; }
    .adf-data-table .adf-datatable-table-cell-header.adf-data-table__header--sorted-asc, .adf-data-table .adf-datatable-table-cell-header.adf-data-table__header--sorted-desc {
      color: rgba(0, 0, 0, 0.87); }
      .adf-data-table .adf-datatable-table-cell-header.adf-data-table__header--sorted-asc:before, .adf-data-table .adf-datatable-table-cell-header.adf-data-table__header--sorted-desc:before {
        ...
        margin-right: 5px;
        vertical-align: sub; }
    .adf-data-table .adf-datatable-table-cell-header.adf-data-table__header--sorted-desc:before {
      content: "\e5db"; }
  .adf-data-table .adf-data-table-cell {
    ...
    .adf-data-table .adf-data-table-cell--image {
      ...
      width: 10px;
      text-align: left; }
      .adf-data-table .adf-data-table-cell--image .cell-value {
        height: 24px; }
    ...
    .adf-data-table .adf-data-table-cell .cell-container {
      display: flex;
      align-items: center; }
  .adf-data-table .adf-location-cell a {
    text-decoration: none;
    color: rgba(0, 0, 0, 0.87); }
    .adf-data-table .adf-location-cell a:hover {
      color: #2196F3;
  ...
  .adf-data-table .adf-loading-content-container {
    ...
    .adf-data-table .adf-loading-content-container > img {
      width: 100%; }
  .adf-data-table .adf-no-permission__row:hover {
    cursor: default;
    background-color: inherit; }
  .adf-data-table .adf-no-permission__cell {
    padding: 0 !important; }
...
.adf-data-table--empty {
  ...
  justify-content: center;
  align-items: center; }
  .adf-data-table--empty .adf-datatable-body .adf-datatable-row {
    background-color: white; }
    .adf-data-table--empty .adf-datatable-body .adf-datatable-row:hover, .adf-data-table--empty .adf-datatable-body .adf-datatable-row:focus {
...
.adf-login-content {
  ...
  @media all and (-ms-high-contrast: none), (-ms-high-contrast: active) {
    .adf-login-content {
      ...
      width: 100%;
      height: 100%; } }
  .adf-login-content .ie11FixerParent {
    margin-top: 16px;
    min-width: 320px; }
    @media all and (-ms-high-contrast: none), (-ms-high-contrast: active) {
      .adf-login-content .ie11FixerParent {
        ...
        width: 100%;
        padding-top: 16px; } }
  .adf-login-content .ie11FixerChild {
    width: 100%;
    display: flex;
    flex-direction: column;
    justify-content: center;
  ...
  .adf-login-content .adf-login-spinner-container {
    margin-left: 15px;
    margin-top: 5px; }
  .adf-login-content #checking-spinner > svg > circle {
  ...
  .adf-login-content .adf-login__field {
    ...
    margin-right: auto;
    padding-bottom: 18px; }
  .adf-login-content .adf-login-rememberme {
...
.adf-pagination {
  ...
  @media (max-width: 500px) {
    .adf-pagination {
      ...
      padding-top: 8px;
      justify-content: space-between; }
    .adf-pagination__range-block.adf-pagination__block:first-child {
      order: 1;
      flex: 0 0 auto;
      box-sizing: border-box;
      padding-left: 16px;
...
.full-screen, .adf-viewer-container .adf-viewer-layout-content, .adf-viewer-container .adf-viewer-layout, .adf-viewer-container .adf-viewer-content, .adf-viewer-inline-container {
  width: 100%;
  height: 100%;
  background-color: white; }
...
.adf-viewer {
  ...
  .adf-viewer__thumbnails {
    ...
    .adf-viewer__thumbnails .adf-info-drawer-layout-content {
      ...
      height: 100%;
      overflow: hidden; }
    .adf-viewer__thumbnails .info-drawer-content {
      height: 100%; }
...
.adf-pdf-viewer {
  ...
  .adf-pdf-viewer__thumbnails {
    ...
    width: 190px;
    background-color: rgba(0, 0, 0, 0.12); }
  .adf-pdf-viewer .thumbnails-template__container {
    display: flex;
    flex-direction: column;
    height: 100%; }
  .adf-pdf-viewer .thumbnails-template__buttons {
    height: 45px;
    justify-content: flex-end;
    align-items: flex-end;
    display: flex;
...
.pdf-thumbnails {
  ...
  .pdf-thumbnails__content {
    ...
    height: 0;
    position: absolute; }
  .pdf-thumbnails__thumb {
    cursor: pointer;
    display: block;
    width: 91px;
    background: #fafafa;
    margin-bottom: 15px; }
  .pdf-thumbnails__thumb:hover {
    box-shadow: 0px 0px 5px 0px rgba(0, 0, 0, 0.87); }
  .pdf-thumbnails__thumb--selected:not(:hover) {
    box-shadow: 0px 0px 5px 0px rgba(0, 0, 0, 0.87); }

.adf-image-viewer .image-container {
  display: flex;
  flex: 1;
  text-align: center;
  flex-direction: row;
  justify-content: center;
  height: 90vh; }
  .adf-image-viewer .image-container img {
    width: 100%;
    object-fit: contain; }
...
.adf-form-validation-button {
  ...
  top: 39px;
  color: #3f51b5; }
  .adf-form-validation-button .invalid-color {
    color: #f44336; }
...
adf-layout-header .mat-toolbar-single-row {
  ...
  adf-layout-header .mat-toolbar-single-row .adf-header-delimiter {
    ...
    background-color: white;
    margin-right: 16px; }
  adf-layout-header .mat-toolbar-single-row .adf-app-layout-user-profile {
    margin-right: 16px; }
...
.adf-analytics-report-list .adf-report-card {
  ...
  .adf-analytics-report-list .adf-report-card-title {
    padding: 16px;
    z-index: 7; }
    .adf-analytics-report-list .adf-report-card-title .application-title {
      font-size: 24px;
      margin: 0; }
