 ...
 */
import { AlfrescoApi, ContentApi, FavoritesApi, NodesApi, PeopleApi, RenditionsApi, SharedlinksApi, SitesApi, VersionsApi, ClassesApi, SearchApi, GroupsApi, MinimalNodeEntryEntity } from 'alfresco-js-api';
...
export declare class AlfrescoApiService {
     ...
     */
    nodeUpdated: Subject<MinimalNodeEntryEntity>;
    protected alfrescoApi: AlfrescoApi;
    getInstance(): AlfrescoApi;
    readonly taskApi: alfrescoApi.TaskApi;
    readonly modelsApi: alfrescoApi.ModelsApi;
    ...
    constructor(appConfig: AppConfigService, storage: StorageService);
    load(): Promise<void>;
    reset(): Promise<void>;
