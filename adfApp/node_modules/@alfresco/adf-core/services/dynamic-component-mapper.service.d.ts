...
export declare type DynamicComponentResolveFunction = (model: DynamicComponentModel) => Type<{}>;
...
export declare abstract class DynamicComponentMapper {
     ...
     */
    getComponentTypeResolver(type: string, defaultValue?: Type<{}>): DynamicComponentResolveFunction;
    /**
     ...
     */
    setComponentTypeResolver(type: string, resolver: DynamicComponentResolveFunction, override?: boolean): void;
    /**
     ...
     */
    resolveComponentType(model: DynamicComponentModel, defaultValue?: Type<{}>): Type<{}>;
}
