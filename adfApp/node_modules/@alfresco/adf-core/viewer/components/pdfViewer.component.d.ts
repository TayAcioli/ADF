 ...
 */
import { TemplateRef, OnChanges, OnDestroy, EventEmitter } from '@angular/core';
...
export declare class PdfViewerComponent implements OnChanges, OnDestroy {
    ...
    constructor(dialog: MatDialog, renderingQueueServices: RenderingQueueServices, logService: LogService);
    ngOnChanges(changes: any): void;
    executePdf(src: any): void;
